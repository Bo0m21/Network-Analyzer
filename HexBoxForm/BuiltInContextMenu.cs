...
namespace HexBoxForm
{
    ...
    public sealed class BuiltInContextMenu : Component
    {
        ...
        /// <summary>
        ///     Contains the "Copy hex"-ToolStripMenuItem object.
        /// </summary>
        private ToolStripMenuItem _copyHexToolStripMenuItem;
        ...
        /// <summary>
        ///     Gets the text of the "Copy hex" ContextMenuStrip item.
        /// </summary>
        internal string CopyHexMenuItemTextInternal =>
            !string.IsNullOrEmpty(CopyMenuItemText) ? CopyMenuItemText : "Copy hex";
        ...
        internal string SelectAllMenuItemTextInternal =>
            !string.IsNullOrEmpty(SelectAllMenuItemText) ? SelectAllMenuItemText : "Select All";
        ...
        private void CheckBuiltInContextMenu()
        {
            ...
            if (_contextMenuStrip == null)
            {
                ...
                _copyHexToolStripMenuItem = new ToolStripMenuItem(CopyHexMenuItemTextInternal, CopyMenuItemImage,
                    CopyHexMenuItem_Click);
        ...
        private void BuildInContextMenuStrip_Opening(object sender, CancelEventArgs e)
        {
            ...
            _copyHexToolStripMenuItem.Enabled = _hexBox.CanCopy();
        ...
        /// <summary>
        ///     The handler for the "Copy hex"-Click event
        /// </summary>
        /// <param name="sender">the sender object</param>
        /// <param name="e">the event data</param>
